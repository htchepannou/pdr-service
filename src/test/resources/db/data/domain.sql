...
-- roles
insert into t_role(id, name) values(400, 'admin');
insert into t_role(id, name) values(401, 'member');
...
insert into t_role(id, name) values(500, 'admin');
insert into t_role(id, name) values(501, 'member');
...
-- grant
insert into t_role(id, name) values(600, 'admin');
insert into t_role(id, name) values(601, 'member');
